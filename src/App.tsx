          ...
          <div className="flex gap-4 h-full w-full max-w-[95rem] overflow-hidden">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
               <div className="skeuo-panel p-4 flex flex-col h-full overflow-hidden">
                 ...
                 <div className="flex-1 overflow-y-auto flex flex-col justify-center gap-3 pr-1">
                   {(() => {
                     if (!networkGmState) {
                     ...
                     const slots = [0, 1, 2];
                     return slots.map((lineIdx) => {
                       const line = rolls[lineIdx];
                       if (!line) {
                         return (
                           <div 
                             key={lineIdx} 
                             className="h-[105px] invisible"
                           />
                         );
                       }
                       ...
                       return (
                         <div 
                           key={lineIdx} 
                           className={cn(
                             "flex flex-col justify-between h-[105px] p-2.5 transition-all rounded-none border",
                             isChecked 
                         ...
                         >
                           <div className="flex items-center justify-between">
                             ...
                             <span className={cn(
                               "text-[8px] font-bold uppercase tracking-wider px-1.5 py-0.5",
                             ...
                             {line.map((req: any, reqIdx: number) => {
                               ...
                               return (
                                 <div 
                                   key={reqIdx} 
                                   className={cn(
                                     "flex-1 py-2 px-1.5 text-center text-[10px] font-bold rounded-none border transition-all truncate",
                                     isChecked 
              ...
              <>
                ...
                {isGmUser && isNetworkActive && (
                  <div className="flex gap-2 relative z-10">
                    <div className={cn(
                      "flex-1 py-1 px-2.5 text-[9px] font-black tracking-widest uppercase text-center border select-none transition-all duration-300",
                      (gameState.gmNotes2 || '') !== (networkGmState?.gmNotes2 || '')
                        ? "bg-amber-950/40 border-amber-500/40 text-amber-400/90 animate-pulse"
                        : "bg-emerald-950/40 border-emerald-500/40 text-emerald-400/90"
                    )}>
                      {(gameState.gmNotes2 || '') !== (networkGmState?.gmNotes2 || '') ? "Saving..." : "Saved to Cloud"}
                    </div>
                  </div>
                )}
              </>
               ...
               <div className="h-[40%] skeuo-panel p-6 flex flex-col min-h-0 overflow-hidden">
                 <div className="flex justify-between items-center mb-3">
                   ...
                   {isNetworkActive && (
                     <div className="flex gap-2">
                       <div className={cn(
                         "px-3 py-1 text-[9px] font-black tracking-widest uppercase border select-none transition-all duration-300",
                         (gameState.gmNotes2 || '') !== (networkGmState?.gmNotes2 || '')
                           ? "bg-amber-950/40 border-amber-500/40 text-amber-400/90 animate-pulse"
                           : "bg-emerald-950/40 border-emerald-500/40 text-emerald-400/90"
                       )}>
