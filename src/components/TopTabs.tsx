        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex-1 min-w-[44px] h-[56px] flex flex-col items-center justify-center px-0.5 py-1 transition-none border-4 border-black box-border cursor-pointer ${
                isActive
                  ? 'bg-[#D0D0D0] text-[#000000] font-normal'
